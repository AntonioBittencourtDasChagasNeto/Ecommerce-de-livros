...
public class Frete {
	public double CalcularFrete(double total, double peso,double caixa,String cep) {
		String nCdEmpresa = "";
		String sDsSenha = ""; 
	...
	public double CalcularFrete2(double altura, double peso,double Comprimento, double Largura ,String cep) {
		String nCdEmpresa = "";
		String sDsSenha = ""; 
		String nCdServico = "41106";
		String sCepOrigem = "09920175";
