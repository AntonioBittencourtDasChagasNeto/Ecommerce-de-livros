...
<body>
	...
	<h3>Confirmar Inativar Livro</h3>
		...
		<fieldset name="fieldset">
			...
			<select name="CategoriaJustificativa" id="CategoriaJustificativa">
				<%
                            try
                            {
                            	String sql = "SELECT * FROM inativar";
                        	...
                        	ResultSet rs = stm.executeQuery(sql);
                            	...
                            	{
                            		%>
				<option value="<%=rs.getInt("idinativar")%>"><%=rs.getString("motivo") %></option>
				<%
			...
			<p>
				<button type="submit" name="operacao" id="botao" value="inativar">Confirmar</button>
			</p>
		</fieldset>
	</form>
</body>
